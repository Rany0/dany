--[[
الالعاب ل سورس ارماندو
تم تعديل الملف واضافه الالعاب من قبل ارماندوᐂ (EEFFI)
--]]
...
return 'اول من يكتب هذا العدد يفوز ↤︎`'..(redis:get(dany..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب هذه السمايل يفوز ↤︎    `'..(redis:get(dany..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(dany.."GAME:CHER"..msg.chat_id_,'شجاع') 
elseif SENDTEXT:find('حي') then
redis:set(dany.."GAME:CHER"..msg.chat_id_,'حي') 
elseif SENDTEXT:find('نشيط') then
redis:set(dany.."GAME:CHER"..msg.chat_id_,'نشيط') 
...
redis:set(dany.."GAME:CHER"..msg.chat_id_,'مو ممنوع') 
