...
██.       ██.     ██.                ██
██  ██.         ██.                     ██         │DANY ﹏ @EEFFI
│تم تطوير وبرمجة السورس من قبل ارماندوᐂ .
─────▀██▀─────
┊dany ‿ @EEFFI
┊@EEFFI ‿ @EEFFI
#-------------------------------------------------------------------
...
─────▀██▀─────
┊ＭᎯẊ ‿ @EEFFI
تم تطوير وبرمجة السورس من قبل مطورين سورس ارماندو
┊@EEFFI ‿ @EEFFI
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/Rany0/dany/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/Rany0/dany/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/Rany0/dany/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/Rany0/dany/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/Rany0/dany/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/Rany0/dany/master/plugins/games.lua','./plugins/games.lua')
