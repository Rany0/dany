...
if redis:get(dany.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'• NAME 𖥳  '..Namei..'    \n• USER 𖦹 '..UserNameID..' .\n• MSG 𖥳   '..msgs..' .\n• STA 𖦹 '..msg.TheRank..' .\n• iD 𖥳 '..msg.sender_user_id_..' .\n• CH 𖦹 @EEl00 .\n▿▿▿',dl_cb,nil)
		else
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/Rany0/danyfile/master/GetVersion.txt' ) or 0
...
return '•اصدار سورس ارماندو : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'•** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ارماندو يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/EEl00"}}}
send_key(msg.sender_user_id_,'   [• قناة سورس : ارماندو](https://t.me/EEl00)' ,nil,inline,msg.id_)
return false
end
...
• م4 «» اوامر الخدمه 
• م5 «»  اوامر المطور
• .[قـنـاه الـسـورس](t.me/EEl00) 
• [ مـطـور الـسـورس ](t.me/EEFFI)
𖥳••••••𖥳⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤𖥳••••••𖥳
...
⌔︙رومانسي 𖠽
 — — — — — — — — —
𝙳𝙴𝚅 𖡇 : [𝚂𝙾𝙽𝙸𝙲 𖡼](https://t.me/EEl00)
𝙲𝙷 𖣲. :[𝙵𝚄𝙲𝙺 𝙾𝙵𝙵 𖡶 ](https://t.me/EEl00)
]]
end
...
elseif Text== "حيدرك" or Text== "حيدر" then return  sendMsg(msg.chat_id_,msg.id_,"[• Source developer 𖦹 Armando↯](https://t.me/EEFFI)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/EEl00) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/EEl00)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/EEl00)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/EEl00)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/EEl00)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/EEl00) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/EEl00)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/EEl00)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/EEl00)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/EEl00)")
